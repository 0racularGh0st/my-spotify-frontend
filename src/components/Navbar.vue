<template>
  <nav>
    <div>
      <img
        class="logo"
        src="../assets/spotify-icon-small.png"
        height="40"
        width="40"
      ...
      <div class="nav-links">
        ...
        >
          <img
            ...
            class="nav-item-img"
          />
          <div class="nav-item-text">Recent</div>
        </a>
        <a
          id="playlist"
          href="/playlists"
        ...
        >
          <img
            ...
            class="nav-item-img"
          />
          <div class="nav-item-text">Playlists</div>
        </a>
      </div>
    </div>
  </nav>
...
const navItems = () => {
  ...
  if (window.location.pathname === "/playlists") playlist.classList.add("isactive");
